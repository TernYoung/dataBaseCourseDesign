...
public class StudentInfo extends JDialog {
    ...
    private static final String[] infocolumn =
            {AppConstants.SNO, AppConstants.SNAME, AppConstants.SEX, AppConstants.AGE,
                    AppConstants.SDEPT, AppConstants.PASSWORD};
    ...
    public void initBtn() {
        ...
        JButton addBtn = new JButton(AppConstants.ADMIN_STUDENTINFO_ADD);
        addBtn.setAlignmentX(Component.CENTER_ALIGNMENT);
        JButton delBtn = new JButton(AppConstants.ADMIN_STUDENTINFO_DEL);
    ...
    private class AddStudent extends JDialog {
        ...
        private final String[] checkregex = {AppConstants.REGEX_SNO, AppConstants.REGEX_SNAME,
                AppConstants.REGEX_SEX, AppConstants.REGEX_AGE, AppConstants.REGEX_SDEPT ,AppConstants.REGEX_PASSWORD};
        private final boolean checknull[] = {false, false, true, true, true, false};
    ...
    private class DelStudent extends JDialog {
        ...
        public DelStudent(StudentInfo frame) {
            super(frame, AppConstants.ADMIN_STUDENTINFO_DEL, true);
            contPanel = new JPanel();
            setContentPane(contPanel);
            setLayout(new BorderLayout(5, 5));
            setResizable(false);
